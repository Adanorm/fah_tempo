Ces scripts pour Linux (testé sous Ubuntu 24.04) et Windows (testé sous Windows 11) ont été créés pour vous aider à optimiser vos couts d'électricité avec des contrats à cout variable. 
